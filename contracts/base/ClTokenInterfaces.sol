...
/**
 * @title abstract contracts for clToken, clErc20 and clDelegator
 * @author Cluster
 * @notice This is a modified version of the Compound CTokenInterfaces abstract
 *         https://github.com/compound-finance/compound-protocol/blob/master/contracts/CTokenInterfaces.sol
 */

contract ClTokenStorage {
    /**
...
abstract contract ClTokenInterface is ClTokenStorage {
    /**
